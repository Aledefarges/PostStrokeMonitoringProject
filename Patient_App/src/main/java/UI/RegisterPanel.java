...
public class RegisterPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        ((GridBagLayout)getLayout()).rowHeights = new int[] {0, 0, 0, 0, 0, 0, 0, 0, 0, 20, 0};
        ...
        add(register_button, new GridBagConstraints(1, 9, 1, 1, 0.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH,
    ...
    private void registerPatient(){
        try{
            ...
            boolean ok_register = connection.sendPatientToServer(patient);
            if(ok_register){
