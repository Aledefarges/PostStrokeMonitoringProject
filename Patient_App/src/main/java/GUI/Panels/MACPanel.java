/*
 * Created by JFormDesigner on Sat Nov 29 19:20:41 CET 2025
 */
...
public class MACPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        ((GridBagLayout)getLayout()).columnWidths = new int[] {246, 0};
        ((GridBagLayout)getLayout()).rowHeights = new int[] {0, 0, 0, 0};
        ((GridBagLayout)getLayout()).columnWeights = new double[] {0.0, 1.0E-4};
        ((GridBagLayout)getLayout()).rowWeights = new double[] {0.0, 0.0, 0.0, 1.0E-4};

        //---- label1 ----
        label1.setText("Insert MAC address of BITalino:");
        ...
        add(done_button, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
            GridBagConstraints.CENTER, GridBagConstraints.BOTH,
