...
public class BITalino {
    ...
    public Vector<RemoteDevice> findDevices() throws InterruptedException {
        /// Search for bluetooth devices in range, returns list w/ found devices
    ...
    public void open(String macAdd, int samplingRate) throws BITalinoException {
        // Connects to a BItalino device. Sampling rate in Hz, accepted values are 1, 10, 100, 1000HZ, Default = 1000Hz
